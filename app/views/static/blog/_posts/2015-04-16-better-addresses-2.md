...
<%= image_tag("2015-04-15-digital-inclusion-scale.png", alt: "Sample from Royal Mail - Find an Address") %>
...
<%= image_tag("2015-04-15-postcode-finder.png", alt: "Sample from Royal Mail - Find an Address") %>
...
This talk demonstrates the problems that users with low digital skills and confidence have with drop-down boxes. These users struggle to work out how to use them.
...
*<%= image_tag("2015-04-15-universal-jobmatch.png", alt: "Sample from Universal Jobmatch") %>*
...
The developer may have built strong validation into the front-end or even into the processing after the form has been submitted, the validation may prevent the service being delivered. Without validation a new address can be entered.
...
The third pattern is “type ahead address entry”, some people call it “smart addresses”. As the user types the website starts to predict what address they are looking for, offering suggestions in either a drop-down box or the main entry field. It looks like this:

<%= image_tag("2015-04-15-google-maps.png", alt: "Sample from Google Maps") %>
...
This pattern can support the entry of addresses that does not exist in any address list and we believe it is simple to use for users with low digital skills or confidence.

It will allow more people to use the service.
...
Address parsing is part of the problem that needs to be tackled to implement this service. Our [service is in Alpha](/services/free-format-address-input)  and yet to be perfected - as our team has previously mentioned [UK addresses are hard, really hard](blog/2015/01/23/give-our-sorting-office-a-try) to handle and interpret. 
...
In addition to our own research we would love to hear your thoughts perhaps even by [trialling our service](/get-involved/trialists). Do [share your thoughts](https://alpha.openaddressesuk.org/get-involved/contact-us).
